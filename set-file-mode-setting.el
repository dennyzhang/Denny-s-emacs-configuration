...
;; Created: 2009-08-01
;; Updated: Time-stamp: <2011-10-28 00:45:21>
;;
;; --8<-------------------------- §separator§ ------------------------>8--
;; (load-file (concat CONTRIBUTOR_CONF "/actionscript/actionscript-mode.el"))
...
;; --8<-------------------------- §separator§ ------------------------>8--
;; crontab
(load-file (concat CONTRIBUTOR_CONF "crontab-mode/crontab-mode.el"))
...
;; --8<-------------------------- §separator§ ------------------------>8--
;;ledger
(add-to-list 'load-path (concat CONTRIBUTOR_CONF "/ledger"))
(load "ledger")
...
;; --8<-------------------------- §separator§ ------------------------>8--
(load-file (concat CONTRIBUTOR_CONF "google-go/go-mode.el"))
(load-file (concat CONTRIBUTOR_CONF "google-go/go-mode-load.el"))
(require 'go-mode-load)
;; --8<-------------------------- §separator§ ------------------------>8--
(load-file (concat CONTRIBUTOR_CONF "puppet-mode/puppet-mode.el"))

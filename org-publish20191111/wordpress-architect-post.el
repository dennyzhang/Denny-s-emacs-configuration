...
(setq list-post-meta
      ...
      '(
        ...
        ("XXX" "644" "TestSubject" "test"
         "TestSubject" "System Design")

        ("XXX" "646" "TestSubject" "test"
         "TestSubject" "System Design")
        
        ("XXX" "648" "TestSubject" "test"
         "TestSubject" "System Design")

        ("XXX" "650" "TestSubject" "test"
         "TestSubject" "System Design")
        ...
        ("5c125e1e9e0733e6ca752c4736692a27" "207" "Explain LSM (Log Structured Merge Trees)" "explain-lsm"
         "Explain LSM (Log Structured Merge Trees)TestSubject" "System Design")

        ("877657a049f0982ce4e407cadf42b4b5" "208" "Deep Dive Into Golang Implementation" "design-golang"
         "Deep Dive Into Golang Implementation" "System Design")
        ...
        ("89c3a44107f6136dfb67ff77bd240015" "211" "Explain CRDTs (Consistent Replicated Data Types)" "explain-crdts"
         "Explain CRDTs (Consistent Replicated Data Types)" "System Design")

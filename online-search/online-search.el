  ...
  (if (listp mode-name)
      (progn
        (if (member "HTML" mode-name)
            ...
            (setq online-search-configuration
                  (make-online-search-struct
                   :search-engine-url-format "http://www.google.com.hk/search?sitesearch=w3school.com.cn&as_q="
                   :start-anchor-str ""
                   :end-anchor-str ""))
          )
...
(defun display-by-w3m(word)
  ...
  (save-excursion
    (let ((search-url (concat (online-search-struct-search-engine-url-format online-search-configuration) word)))
      (w3m (concat search-url) t)

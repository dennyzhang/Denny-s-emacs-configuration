...
(setq ispell-personal-dictionary
      (concat CONF-EMACS-DATA "/filebat.ispell_english"))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; blog
(defalias 'blog (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/blog/blog.org"))))
...
(defalias 'github (lambda() (interactive) (my-open-file (concat CONF-GITHUB-DIR "/knowledgebase/maintain-github-repos/README.org"))))
(defalias 'sell (lambda() (interactive) (my-open-file (concat CONF-GITHUB-DIR "/knowledgebase/developer-technical-selling/README.org"))))
...
(defalias 'doc (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/blog/doc.org"))))
(defalias 'monetize (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/blog/monetize.org"))))
(defalias 'community (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/blog/community.org"))))
...
(defalias 'career (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/career.org"))))
(defalias 'work (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/work/work.org"))))
(defalias 'soteria (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/work/soteria.org"))))
(defalias 'manage (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/manage.org"))))
(defalias 'often (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/often.org"))))
(defalias 'current (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/current.org"))))
(defalias 'english (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/life/english.org"))))
(defalias 'career (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/career.org"))))
(defalias 'learn (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/life/learn.org"))))
(defalias 'mydiary (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/life/diary.org"))))
(defalias 'career (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/career.org"))))
(defalias 'question (lambda() (interactive) (my-open-file (concat CONF-SHARE-DIR "/org_data/life/question.org"))))
;; --8<-------------------------- separator ------------------------>8--
...
(setq eshell-aliases-file (concat CONF-EMACS-DATA "/filebat.alias"))
(setq bookmark-default-file (concat CONF-EMACS-DATA "/filebat.bmk"))

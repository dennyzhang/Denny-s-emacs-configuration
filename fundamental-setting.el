...
;; Created:2008-10-01
;; Updated: Time-stamp: <2018-06-23 23:51:54>
;; --8<-------------------------- separator ------------------------>8--
...
(defalias 'ai (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/technical/ai.org"))))
(defalias 'docker (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/technical/docker.org"))))
(defalias 'chef (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/technical/chef.org"))))
(defalias 'ios (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/technical/ios.org"))))
(defalias 'web (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/technical/web.org"))))
(defalias 'language (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/technical/language.org"))))
;; languages
...
(defalias 'tax (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/blog/tax.org"))))
(defalias 'doc (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/blog/doc.org"))))
(defalias 'monetize (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/blog/monetize.org"))))
(defalias 'community (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/blog/community.org"))))
...
(defalias 'password (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/life/password.org"))))
(defalias 'contact (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/life/contacts.org"))))
(defalias 'wealth (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/life/wealth.org"))))
...
(defalias 'work (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/work/work.org"))))
(defalias 'soteria (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/work/soteria.org"))))
(defalias 'manage (lambda() (interactive) (my-open-file (concat EMACS_DATA "/org_data/manage.org"))))

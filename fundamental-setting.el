...
;; Created:2008-10-01
;; Updated: Time-stamp: <2018-07-01 01:25:22>
;; --8<-------------------------- separator ------------------------>8--
...
;; technical
(defalias 'linux (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/linux.org"))))
(defalias 'openstack (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/openstack.org"))))
(defalias 'cloud (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/cloud.org"))))
(defalias 'security (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/security.org"))))
(defalias 'ai (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/ai.org"))))
(defalias 'devops (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/devops.org"))))
(defalias 'ai (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/ai.org"))))
(defalias 'docker (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/docker.org"))))
(defalias 'chef (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/chef.org"))))
(defalias 'ios (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/ios.org"))))
(defalias 'web (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/web.org"))))
(defalias 'language (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/language.org"))))
;; languages
(defalias 'java (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/java.org"))))
(defalias 'python (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/python.org"))))
(defalias 'sa (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/sa.org"))))
(defalias 'db (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/technical/db.org"))))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; blog
(defalias 'blog (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/blog.org"))))
(defalias 'review (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/review.org"))))
(defalias 'brain (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/code.org"))))
(defalias 'design (lambda() (interactive) (my-open-file (concat GITHUB_DIR "/system-design-challenge/design.org"))))
(defalias 'emacs (lambda() (interactive) (my-open-file (concat GITHUB_DIR "/cheatsheet-emacs-A4/README.org"))))
(defalias 'golang (lambda() (interactive) (my-open-file (concat GITHUB_DIR "/cheatsheet/cheatsheet-golang-A4/golang.org"))))
(defalias 'cheatsheet (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/cheatsheet.org"))))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defalias 'us (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/us.org"))))
(defalias 'house (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/house.org"))))
(defalias 'stock (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/stock.org"))))
(defalias 'tax (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/tax.org"))))
(defalias 'doc (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/doc.org"))))
(defalias 'monetize (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/monetize.org"))))
(defalias 'community (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/blog/community.org"))))

;; life
(defalias 'idea (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/idea.org"))))
(defalias 'life (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/life.org"))))
(defalias 'health (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/health.org"))))
(defalias 'password (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/password.org"))))
(defalias 'contact (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/contacts.org"))))
(defalias 'wealth (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/wealth.org"))))

;; work
(defalias 'osc (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/work/osc.org"))))
...
(defalias 'skill (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/org_share/skill.org"))))
(defalias 'motto (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/motto.org"))))
(defalias 'career (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/career.org"))))
(defalias 'work (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/work/work.org"))))
(defalias 'soteria (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/work/soteria.org"))))
(defalias 'manage (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/manage.org"))))
(defalias 'often (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/often.org"))))
(defalias 'current (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/current.org"))))
(defalias 'english (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/english.org"))))
(defalias 'career (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/career.org"))))
(defalias 'learn (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/learn.org"))))
(defalias 'mydiary (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/diary.org"))))
(defalias 'career (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/career.org"))))
(defalias 'question (lambda() (interactive) (my-open-file (concat SHARE_DIR "/org_data/life/question.org"))))
;; --8<-------------------------- separator ------------------------>8--
